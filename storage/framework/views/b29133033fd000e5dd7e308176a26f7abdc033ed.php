...
} elseif ($_instance->childHasBeenRendered('iXCcvxW')) {
    $componentId = $_instance->getRenderedChildComponentId('iXCcvxW');
    $componentTag = $_instance->getRenderedChildComponentTagName('iXCcvxW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iXCcvxW');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('iXCcvxW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /media/amr/Drive/Training/RMZ/resources/views/layouts/app.blade.php ENDPATH**/ ?>