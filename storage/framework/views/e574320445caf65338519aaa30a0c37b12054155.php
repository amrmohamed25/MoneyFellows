...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo'); ?> 
            ...
            <a class="navbar-brand logo-image" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('images/web_logo.png')); ?>"  alt="alternative"></a>
...
<?php endif; ?>
            ...
            <div class="mt-4">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.label','data' => ['for' => 'phone_number','value' => ''.e(__('Phone Number')).'']]); ?>
<?php $component->withName('jet-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['id' => 'phone_number','class' => 'block mt-1 w-full','type' => 'tel','value' => old('phone_number'),'name' => 'phone_number','pattern' => '[0]{1}[0-9]{10}','placeholder' => 'ex: 01234567890 (11 digit)','required' => true]]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'phone_number','class' => 'block mt-1 w-full','type' => 'tel','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('phone_number')),'name' => 'phone_number','pattern' => '[0]{1}[0-9]{10}','placeholder' => 'ex: 01234567890 (11 digit)','required' => true]); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="mt-4">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.label','data' => ['for' => 'national_id','value' => ''.e(__('National ID')).'']]); ?>
<?php $component->withName('jet-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'national_id','value' => ''.e(__('National ID')).'']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['id' => 'national_id','class' => 'block mt-1 w-full','type' => 'tel','value' => old('national_id'),'name' => 'national_id','pattern' => '[0-9]{14}','placeholder' => 'ex: 12345678912345 (14 digits)','required' => true]]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'national_id','class' => 'block mt-1 w-full','type' => 'tel','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('national_id')),'name' => 'national_id','pattern' => '[0-9]{14}','placeholder' => 'ex: 12345678912345 (14 digits)','required' => true]); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /media/amr/Drive/Training/RMZ/moneyfellows.github.io/resources/views/auth/register.blade.php ENDPATH**/ ?>