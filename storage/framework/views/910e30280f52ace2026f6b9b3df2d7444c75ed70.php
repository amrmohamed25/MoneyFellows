...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4" style="float:left ;margin-left:40px">
...
<form action="<?php echo e(route('register')); ?>" style="float:right;margin-top:15px">
    <?php echo csrf_field(); ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['class' => 'ml-4']]); ?>
<?php $component->withName('jet-button'); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH F:\Training\RMZ\moneyfellows.github.io\resources\views/auth/login.blade.php ENDPATH**/ ?>